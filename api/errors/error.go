...
var ErrEstYearRequired = ApiError{Code: 422, Message: "Please enter business established year!"}
var ErrValidEstYearRequired = ApiError{Code: 422, Message: "Please enter valid business established year!"}
var ErrAmountRequired = ApiError{Code: 422, Message: "Please enter valid amount!"}
var ErrTotalProfitRequired = ApiError{Code: 422, Message: "Please enter valid total profit value!"}
var ErrAvgAssetsRequired = ApiError{Code: 422, Message: "Please enter valid avg assets value!"}
var ErrProviderRequired = ApiError{Code: 422, Message: "Please choose valid provider!"}
var ErrBusinessNameRequired = ApiError{Code: 422, Message: "Please enter business name!"}
...
var InvalidCurlRequest = ApiError{Code: 401, Message: "invalid curl request"}
